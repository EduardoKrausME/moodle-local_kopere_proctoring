...
$string['heading_info'] = 'Collects lightweight browser-side security telemetry, such as integrity changes and possible use of developer tools, and sends periodic pulses that can be correlated with suspicious proctoring events.';
...
$string['requirement_label'] = 'Understand the security signals policy';
$string['start_message'] = 'During the exam, the system may check browser integrity signals and record suspicious security-related changes in the attempt.';
