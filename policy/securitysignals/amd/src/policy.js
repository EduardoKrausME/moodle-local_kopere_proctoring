...
define(["jquery"], function ($) {
        ...
        function devtoolsSuspected(threshold) {
            // Heuristic only. Not reliable.
            var t = Number(threshold || 160);
        ...
        function init(ctx, cfg) {
            ...
            var pulseMs = Number(cfg.pulsems || 8000);
            ...
            function pulse() {
                ...
                var devtools = devtoolsSuspected(threshold);

                // Only report when something is suspicious.
                if (integrity.integrityok === 1 && !devtools) {
                    return;
                }
                ...
                if (integrity.integrityok === 0) {
                    ...
                    // eslint-disable-next-line no-console
                    console.warn(getString("js_warn_devtools", component, "Suspicious activity detected."));
                }
            }
