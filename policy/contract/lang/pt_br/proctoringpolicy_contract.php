...
$string['enabled_desc'] = 'Se ativado, os alunos devem ler e aceitar um termo/contrato antes de iniciar a prova.';
$string['error_not_accepted'] = 'Você deve aceitar o contrato antes de iniciar a prova.';
$string['heading'] = 'Contrato / termo de ciência ';
$string['heading_info'] = 'Adiciona uma etapa obrigatória de ciência antes do início da tentativa. A política exibe um contrato antes da tentativa, armazena o texto específico do módulo do curso e só libera o aluno para o fluxo da prova após o aceite explícito.';
$string['legend'] = 'Contrato / termo de ciência';
...
$string['message_default'] = 'Texto padrão do termo/contrato';
$string['message_default_desc'] = 'Texto padrão do termo/contrato exibido antes do início da prova.';
