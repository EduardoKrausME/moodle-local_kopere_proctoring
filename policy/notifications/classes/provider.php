...
class provider implements policy_interface {
    ...
    public static function add_admin_settings(admin_settingpage $settings): void {
        ...
        $settings->add(
            new admin_setting_confightmleditor(
                ...
                "Course: {coursename}<br>Exam: {quizname}<br>Event: {event}<br>Reason: {reason}"
            )
        );
    }
    ...
    public static function add_module_form(moodleform_mod $formwrapper, MoodleQuickForm $mform, int $cmid): void {
        ...
        $mform->addElement("html", "<fieldset class='proctoring-block'><legend>" . get_string("legend", "proctoringpolicy_notifications") . "</legend>");

        $mform->addElement("advcheckbox", "kopere_policy_notifications_enabled",
            get_string("enabled_cm", "proctoringpolicy_notifications"));
        $mform->setType("kopere_policy_notifications_enabled", PARAM_INT);
        $mform->setDefault("kopere_policy_notifications_enabled", 0);
        ...
        $mform->addElement("select", "kopere_policy_notifications_moment", get_string("moment_cm", "proctoringpolicy_notifications"), $choices);
        ...
        $mform->addElement("text", "kopere_policy_notifications_recipients", get_string("recipients_cm", "proctoringpolicy_notifications"), ["size" => 60]);
        ...
        $mform->addElement("text", "kopere_policy_notifications_subject", get_string("subject_cm", "proctoringpolicy_notifications"), ["size" => 60]);
