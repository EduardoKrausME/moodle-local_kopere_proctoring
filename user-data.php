...
foreach ($attempts as $attempt) {
    ...
    $rows[] = [
        ...
        'timestart' => $attempt->timestart ? userdate($attempt->timestart, get_string('strftimedatetimeshort', 'langconfig')) : '-',
        'timefinish' => $attempt->timefinish ? userdate($attempt->timefinish, get_string('strftimedatetimeshort', 'langconfig')) : '-',
        'contractaccepted' => !empty($attempt->contract),
        'contractacceptedlabel' => !empty($attempt->contract) ? get_string('yes') : get_string('no'),
        'contracttime' => $attempt->contract_time ? userdate($attempt->contract_time, get_string('strftimedatetimeshort', 'langconfig')) : '-',
