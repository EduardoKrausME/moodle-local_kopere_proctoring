...
class core_hook_output {
    ...
    public static function before_footer_html_generation(before_footer_html_generation $hook): void {
        ...
        $enable = get_config('local_kopere_proctoring', "local_kopere_proctoring_enable_{$cmid}");
        if (!$enable) {
            return;
        }
        ...
        // Mustache data (mesma ideia que você já tinha).
        $mustachedata = [];
        ...
        manager::add_page_requirements($cmid, $attemptid);
