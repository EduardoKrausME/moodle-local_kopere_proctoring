...
/**
 * Plugininfo for proctoringpolicy_* subplugins.
 *
...
namespace local_kopere_proctoring\plugininfo;
...
/**
 * Manages admin UI + enable/disable + uninstall for proctoringpolicy_* subplugins.
 *
 * Enable/disable model:
 *   component = 'proctoringpolicy_<name>'  |  key = 'enabled' (1/0, default 1)
 */
class proctoringpolicy extends base {

    /**
     * Return enabled status for all proctoringpolicy subplugins.
     * Keys are raw plugin names (e.g. 'html', 'course'); values are booleans.
     *
     * @return array<string,bool>
     */
    public static function get_enabled_plugins() {
        $plugins = core_component::get_plugin_list("proctoringpolicy");
        return $plugins;
    }
    ...
    public static function get_manage_url() {
        return new moodle_url("/local/kopere_proctoring/admin_plugins.php?subtype=proctoringpolicy");
    }
}
